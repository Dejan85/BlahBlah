...
> Poslednje ažuriranje: **2026-06-24** (T3.1 — `lib/formatCount.ts`, Faza 3 počela)
...
| **Blah Score / Streak / Recovery** | 8% | ~8% |
...
- **Faza 3** — signature mehanike (Blah Score → streak → recovery → ephemeral → premium) — **najveći blok, U TOKU (T3.1 ✅, sledeći T3.2)**, sve kroz `lib/` + testovi (`ARCHITECTURE.md` §2.5)
