...
> Poslednje ažuriranje: **2026-06-24** (T3.2 — `lib/blahScore.ts`, Blah Score formula)
...
| **Blah Score / Streak / Recovery** | 8% | ~12% |
...
- **Faza 3** — signature mehanike (Blah Score → streak → recovery → ephemeral → premium) — **najveći blok, U TOKU (T3.1 ✅, T3.2 ✅, sledeći T3.3 — DB)**, sve kroz `lib/` + testovi (`ARCHITECTURE.md` §2.5)
